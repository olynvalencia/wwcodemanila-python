...
customer_input = input('Please enter text: ')
customer_input_arr = customer_input.split( )

name = ' '.join(customer_input_arr[1:len(customer_input_arr)-1])
reward_index = int(customer_input_arr[0]) - 1
print("Hi {}! You have successfully redeem reward #{} - {}! Thank you for choosing Aling Nena's Sari-sari store"
    .format(name, customer_input_arr[0],rewards[reward_index]))